 ...
 */
public class OPS_Compound_InformationNodePlugin extends Plugin {
    // The shared instance.
    private static OPS_Compound_InformationNodePlugin plugin;

    /**
     * The constructor.
     */
    public OPS_Compound_InformationNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static OPS_Compound_InformationNodePlugin getDefault() {
        return plugin;
    }
