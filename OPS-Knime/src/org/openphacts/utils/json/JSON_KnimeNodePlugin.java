 ...
 */
public class JSON_KnimeNodePlugin extends Plugin {
    // The shared instance.
    private static JSON_KnimeNodePlugin plugin;

    /**
     * The constructor.
     */
    public JSON_KnimeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static JSON_KnimeNodePlugin getDefault() {
        return plugin;
    }
