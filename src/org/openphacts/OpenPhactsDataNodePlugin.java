 ...
 * @author OpenPhacts
 */
public class OpenPhactsDataNodePlugin extends Plugin {
    // The shared instance.
    private static OpenPhactsDataNodePlugin plugin;

    /**
     * The constructor.
     */
    public OpenPhactsDataNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static OpenPhactsDataNodePlugin getDefault() {
        return plugin;
    }
